...
base4 AS (SELECT "PS Number",
        ...
        "Logged by",
        "Team Lead",
         CASE WHEN LOWER("Entry Label") LIKE '%dec%' 
             OR LOWER("Entry Label") LIKE '%jan%' 
             OR LOWER("Entry Label") LIKE '%mar%' THEN "Task pertaining to previous or next month will not be paid"
