...
base4 AS (SELECT "PS Number",
        ...
        "Logged by",
        "Team Lead",
         CASE WHEN LOWER("Entry Label") LIKE '%july%' 
             OR LOWER("Entry Label") LIKE '%august%' 
             OR LOWER("Entry Label") LIKE '%october%' THEN "Task pertaining to previous or next month will not be paid"
