...
base4 AS (SELECT "PS Number",
        ...
        "Logged by",
        "Team Lead",
         CASE WHEN LOWER("Entry Label") LIKE '%sept%' 
             OR LOWER("Entry Label") LIKE '%oct%' 
             OR LOWER("Entry Label") LIKE '%dec%' THEN "Task pertaining to previous or next month will not be paid"
