...
base4 AS (SELECT "PS Number",
        ...
        "Logged by",
        "Team Lead",
         CASE WHEN LOWER("Entry Label") LIKE '%feb%' 
             OR LOWER("Entry Label") LIKE '%march%' 
             OR LOWER("Entry Label") LIKE '%may%' THEN "Task pertaining to previous or next month will not be paid"
